...
import Project.CinnamonProducts.dto.ReviewRequest;
import Project.CinnamonProducts.dto.EditReviewRequest;
import Project.CinnamonProducts.model.Review;
import Project.CinnamonProducts.service.ReviewService;
...
public class ReviewController {
    ...
    @PostMapping("/secure")
    public ResponseEntity<?> submitReviewSecure(@Valid @RequestBody ReviewRequest reviewRequest) {
        try {
