    ...
    public void sendCustomerNotification(String toEmail, String subject, String messageText) {
        try {
            if (mailSender != null) {
                ...
                System.out.println("📧 CUSTOMER EMAIL SENT VIA SMTP");
            } else {
                // Simulation for development when mail sender is not configured
                System.out.println("📧 CUSTOMER EMAIL NOTIFICATION (SIMULATION):");
                System.out.println("To: " + toEmail);
                System.out.println("Subject: " + subject);
                System.out.println("Message: " + messageText);
                System.out.println("--- Email sent to customer (simulated) ---");
            }
    ...
    public void sendAdminNotification(String subject, String messageText) {
        try {
            if (mailSender != null) {
                ...
                message.setText(messageText);
                mailSender.send(message);
                System.out.println("📧 ADMIN NOTIFICATION SENT VIA SMTP");
            } else {
                // Simulation for development when mail sender is not configured
                System.out.println("📧 ADMIN NOTIFICATION (SIMULATION):");
                System.out.println("To: " + adminEmail);
                System.out.println("Subject: " + subject);
                System.out.println("Message: " + messageText);
                System.out.println("--- Admin notification sent (simulated) ---");
            }
